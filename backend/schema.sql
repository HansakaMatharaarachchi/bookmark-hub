...
CREATE TABLE tag (
    ...
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_tag_member_id FOREIGN KEY (member_id) REFERENCES member(member_id),
...
CREATE TABLE bookmark_tag (
    ...
    CONSTRAINT fk_bookmark_tag_tag_id FOREIGN KEY (tag_id) REFERENCES tag(tag_id)
);
